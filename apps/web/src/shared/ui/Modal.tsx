...
export default function Modal({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'border-main-board-border flex min-h-[196px] min-w-[500px] flex-col rounded-[20px] border-[1px] bg-white px-[40px] pb-[20px]',
          className,
...
function ModalHeader({ title, className, children }: ModalHeaderProps) {
  return (
    <>
      <p
        className={cn(
          'text-light mb-[17px] flex h-[64px] place-items-start items-center text-start',
          className,
        )}
      >
        {title}
